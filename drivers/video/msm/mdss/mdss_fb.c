...
{		  	
	...
	if (!strncmp(LcdPanelName, TD4291_JDI_720P_VIDEO_PANEL, strnlen(TD4291_JDI_720P_VIDEO_PANEL, PANEL_NAME_MAX_LEN)))
        ...
        else if (!strncmp(LcdPanelName, HOLITECH_HX8394F_720P_VIDEO_PANEL, strnlen(HOLITECH_HX8394F_720P_VIDEO_PANEL, PANEL_NAME_MAX_LEN)))
        strcpy(module_name, "IC:HX8394F; Glass:HOLITECH; Resolution:720*1280");
        else if (!strncmp(LcdPanelName, LEAD_HX8394F_720P_VIDEO_PANEL, strnlen(LEAD_HX8394F_720P_VIDEO_PANEL, PANEL_NAME_MAX_LEN)))
        strcpy(module_name, "IC:HX8394F; Glass:LEAD; Resolution:720*1280");
        else if (!strncmp(LcdPanelName, SHARP_NT35695_1080P_VIDEO_PANEL, strnlen(SHARP_NT35695_1080P_VIDEO_PANEL, PANEL_NAME_MAX_LEN)))
        strcpy(module_name, "IC:NT35695+SHARP; Glass:SHARPV; Resolution:1080*1920");
        else if (!strncmp(LcdPanelName, SHARP_NT35695_1080P_CMD_PANEL, strnlen(SHARP_NT35695_1080P_CMD_PANEL, PANEL_NAME_MAX_LEN)))
        strcpy(module_name, "IC:NT35695+SHARP; Glass:SHARPC; Resolution:1080*1920");
        else if (!strncmp(LcdPanelName, DJN_NT35521S_720P_VIDEO_PANEL, strnlen(DJN_NT35521S_720P_VIDEO_PANEL, PANEL_NAME_MAX_LEN)))
        strcpy(module_name, "IC:NT35521S+DJN; Glass:BOE; Resolution:720*1280");
        else if (!strncmp(LcdPanelName, YUSHUN_NT35521S_720P_VIDEO_PANEL, strnlen(YUSHUN_NT35521S_720P_VIDEO_PANEL, PANEL_NAME_MAX_LEN)))
        strcpy(module_name, "IC:NT35521S+YUSHUN; Glass:CPT; Resolution:720*1280");
	else
