...
{
	if (fpc1020->chip.type == FPC1020_CHIP_1155X) {
		return fpc1020_write_cb_test_setup_1155(fpc1020, invert);
	} else if (fpc1020->chip.type == FPC1020_CHIP_1145X) {
		return fpc1020_write_cb_test_setup_1145(fpc1020, invert);
	} else {
		return fpc1020_write_cb_test_setup_102x(fpc1020, invert);
	}
}
