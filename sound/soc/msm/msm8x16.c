...
static int msm_proxy_rx_ch = 2;
  ...
  atomic_t quat_mi2s_rsc_ref_8x16;//weiguohua modify for the warning both define in msm8939-slimbus.c
#endif
...
static struct snd_soc_dai_link msm8x16_dai[] = {
	...
	.codec_dai_name = "tfa98xx_codec",// .codec_dai_name = "snd-soc-dummy-dai",
	 .codec_name = "tfa98xx.3-0034",//.codec_name = "snd-soc-dummy",
	#else
	...
	#endif
		.be_id = MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,  //weiguohu addd	
		.ignore_suspend = 1,
		/* this dainlink has playback support */
		.ignore_pmdown_time = 1,
	},
